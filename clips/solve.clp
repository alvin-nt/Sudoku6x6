...
(defrule locked-candidate-single-line-diagonal
   ...
   (possible (value ?v)  (group ?g) (diagonal ?d))
   
   (not (possible (value ?v) (group ?g) (diagonal ~?d)))
   
   (possible (value ?v) (group ~?g) (diagonal ?d&:(< 0 ?d)) (id ?id))
...
(defrule naked-triples-diagonal
   ...
   (possible (value ?v1) (diagonal ?c) (id ?id1))
   
   (not (possible (value ~?v1&~?v2&~?v3) (id ?id1)))
   
   (possible (value ?v2) (diagonal ?c) (id ?id2&~?id1))

   (not (possible (value ~?v1&~?v2&~?v3) (id ?id2)))
   
   (possible (value ?v3) (diagonal ?c) (id ?id3&~?id2&~?id1))
   
   (not (possible (value ~?v1&~?v2&~?v3) (id ?id3)))
   
   (possible (value ?v& ?v1 | ?v2 | ?v3) (diagonal ?c) (id ?id&~?id1&~?id2&~?id3))
...
(defrule hidden-triples-diagonal
   ...
   (possible (value ?v1) (id ?id1) (diagonal ?d))
   
   (possible (value ?v2) (id ?id2&~?id1) (diagonal ?d))
   
   (possible (value ?v3) (id ?id3&~?id2&~?id1) (diagonal ?d))
   
   (not (possible (value ?v1 | ?v2 | ?v3) (id ~?id3&~?id2&~?id1) (diagonal ?d)))
