(defrule grid-values
   ...
   (assert (possible (row 1) (column 3) (value 1) (diagonal 0) (group 1) (id 3)))
   ...
   (assert (possible (row 2) (column 4) (value 1) (diagonal 0) (group 2) (id 10)))
   (assert (possible (row 2) (column 5) (value 3) (diagonal 2) (group 2) (id 11)))
   (assert (possible (row 2) (column 6) (value 5) (diagonal 0) (group 2) (id 12)))

   (assert (possible (row 3) (column 1) (value any) (diagonal 0) (group 3) (id 13)))
   (assert (possible (row 3) (column 2) (value 6) (diagonal 0) (group 3) (id 14)))
   (assert (possible (row 3) (column 3) (value any) (diagonal 1) (group 3) (id 15)))
   (assert (possible (row 4) (column 1) (value 4) (diagonal 0) (group 3) (id 16)))
   ...
   (assert (possible (row 3) (column 4) (value 4) (diagonal 2) (group 4) (id 19)))
   (assert (possible (row 3) (column 5) (value any) (diagonal 0) (group 4) (id 20)))
   (assert (possible (row 3) (column 6) (value 2) (diagonal 0) (group 4) (id 21)))
   ...
   (assert (possible (row 5) (column 1) (value 3) (diagonal 0) (group 5) (id 25)))
   ...
   (assert (possible (row 6) (column 5) (value 6) (diagonal 0) (group 6) (id 35)))
